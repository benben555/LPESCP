...
if __name__ == "__main__":
    ...
    print("Deciphertext: ", libnum.s2n(deciphertext))
...
#     c1 = pai.encipher(str(x))
#     # c1 = gy.powmod(g_U, x, N_U ** 2) * gy.powmod(r1, N_U, N_U ** 2) % (N_U ** 2)
...
#         r2 += 1
#     s = random.randrange(1, N_U // 1000000)
#     # print("s:",s)
#     y = 29
#     c2 = gy.powmod(c1, s, N_U ** 2) * gy.invert(gy.powmod(g_U, s * y, N_U ** 2), N_U ** 2) * gy.powmod(r2, N_U,
#                                                                                                        N_U ** 2) % (
#                  N_U ** 2)
#     # c3 = gy.powmod(g_U, s * (x - y), N_U ** 2) * gy.powmod(gy.powmod(r1, s, N_U ** 2) * r2, N_U, N_U ** 2) % (
#     #         N_U ** 2)
#     # print(c2 == c3)
#     f = pai.decipher(c2)
#     f = libnum.s2n(f)
